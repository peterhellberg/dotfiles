...
then
  ...
  if [[ -v CONTAINER_ID ]]; then 
    export PS1='\[$RED\]${CONTAINER_ID}\[$RESET_COLOR\] on \[$GREEN\]blade \[$WHITE\]\w \[$YELLOW\]$(parse_git_branch)\[$GREEN\]\n\[$GREEN\]\$\[$RESET_COLOR\] '
  else
    export PS1='\[$GREEN\]blade \[$WHITE\]\w \[$YELLOW\]$(parse_git_branch)\[$GREEN\]\n\[$GREEN\]\$\[$RESET_COLOR\] '
  fi
